      ...
      <section className="section">
        <div className="section__header">
          ...
          <p className="page-lead">
            최근 3개월 급여만 넣으면 퇴직금이 낮게 나옵니다. 상여금과 연차수당을 빠뜨리지 않아야 정확한 금액이 나옵니다.
          </p>
        </div>
        ...
        <div className="panel">
          ...
          <ul className="plain-list">
            <li>퇴직금 기준은 <strong>평균임금</strong>입니다. 평균임금이 통상임금보다 낮으면 통상임금을 적용합니다.</li>
