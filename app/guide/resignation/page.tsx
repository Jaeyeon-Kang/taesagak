      ...
      <section className="section">
        ...
        <div className="value-grid">
          <article className="value-card">
            <h3>퇴직금 기준일</h3>
            <p>
              법정 퇴직금은 계속근로 1년 이상부터 발생합니다.
              입사일로부터 딱 365일째가 기준이 됩니다.
              359일 차에 퇴사하면 퇴직금이 0원입니다.
            </p>
          </article>
          <article className="value-card">
            <h3>연차수당 발생 시점</h3>
            <p>
              1년 미만 근로자는 월 1개씩 연차가 생깁니다.
              1년 이상이면 15개(최대 25개).
              퇴사 전 남은 연차를 다 쓰거나 수당으로 받아야 손해가 없습니다.
            </p>
          </article>
          <article className="value-card">
            <h3>주휴수당 마지막 주</h3>
            <p>
              마지막 주에 소정 근로일을 개근하면 그 주의 주휴수당도 발생합니다.
          ...
          <article className="value-card">
            <h3>실업급여 요건</h3>
            <p>
              고용보험 180일(약 6개월) 이상 가입, 비자발적 이직이어야 합니다.
              자발적 퇴사라도 임금체불·직장 내 괴롭힘 등 불가피한 사유라면 수급 가능합니다.
            </p>
          </article>
        </div>
      </section>
